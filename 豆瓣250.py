...
def open_url(url):
    ...
    headers={'user-agent':'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36 Edge/17.17134'}
...
def main():
    ...
    with open("DouBanTop250.txt","w",encoding="utf-8") as file:
        for each in result:
            file.write(each) 
